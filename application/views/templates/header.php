...
<html lang="en">
  <head>
    ...
    <meta name="description" content="HD Window Cleaning is a professional window cleaning service for Calgary and area. We do residential and commercial window cleaning.">
    <title><?=$title ?></title>
